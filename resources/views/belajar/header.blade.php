        ...
        <div class="navbar-collapse-header d-md-none">
          <div class="row">
            <div class="col-6 collapse-brand">
              <a href="/api-data">
                <span class="fa fa-home" style="font-size: 24px;color: black;"></span>
              </a>
            </div>
        ...
        <div class="row" id="body-row">
          ...
          <div id="sidebar-container" class="sidebar-expanded "><!-- d-* hiddens the Sidebar in smaller devices. Its itens can be kept on the Navbar 'Menu' -->
            ...
            <ul class="list-group">
              ...
              <a href="/diagram" class="list-group-item list-group-item-action">
                <div class="d-flex w-100 justify-content-start align-items-center">
                    <span class="fa fa-bars  mr-3 " style="color: #399e4b !important;"></span>
                    <span class="menu-collapsed">Belajar Diagram</span>
                </div>
              </a>
              <a href="/spk-saw" class="list-group-item list-group-item-action">
                <div class="d-flex w-100 justify-content-start align-items-center">
                    <span class="fa fa-book  mr-3 " style="color: #399e4b !important;"></span>
                    <span class="menu-collapsed">SPK-SAW</span>
                </div>
              </a>
              <!-- <a href="/api-data/jadwalsholat" class="list-group-item list-group-item-action">
                <div class="d-flex w-100 justify-content-start align-items-center">
                    <span class="fa fa-bullhorn  mr-3 " style="color: #399e4b !important;"></span>
                    <span class="menu-collapsed">Jadwal Sholat</span>
                </div>
              </a> -->
        ...
        <ul class="navbar-nav align-items-center d-none d-md-flex">
          <li class="nav-item dropdown">
            <a class="nav-link pr-0" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
              <div class="media align-items-center">
                <span class="avatar avatar-sm rounded-circle">
                  <i class="fa fa-user " style="color: #399e4b !important;"></i>
                </span>
